from care.wachter import WACHTER
from evaluate_counterfactuals import evaluateCounterfactuals
from recover_originals import recoverOriginals

def WACHTERExplainer(x_ord, X_train, Y_train, dataset, task, predict_fn, predict_proba_fn, explainer=None,
    ...
    if explainer is None:
        ...
        explainer = WACHTER(dataset, task=task, predict_fn=predict_fn, predict_proba_fn=predict_proba_fn,
